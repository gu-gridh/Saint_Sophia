"""
Django settings for saintsophia project.
...
DATABASE_ROUTERS = ['saintsophia.routers.DjangoRouter', 'saintsophia.routers.AppRouter']
...
REST_FRAMEWORK = {
    ...
    # 'DEFAULT_SCHEMA_CLASS': 'saintsophia.abstract.schemas.SaintSophiaSchema',
